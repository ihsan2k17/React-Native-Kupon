...
import DropdownListCustomerNakami from '../dropdown/dropdownliscustfornakami';
import DropdownListSalesForNakami from '../dropdown/dropdownlissalesfornakami';
import { CustomerNkm } from '../../../models/customerNakami';
import DropdownCustomerNakamiJenis from '../dropdown/dropdownjenisNKM';
import { SelectTopIdCustomerNKM } from '../../../service/fetchCustomerNakami';
import DropdownListAgenCustomer from '../dropdown/dropdownlistagenfornakami';
...
const FormAddDataCustomerNakami = ({
    ...
    const [id, setID] = useState<CustomerNkm[]>([]);

    useEffect(() => {
        
    },[])
    const handleSelectTopIdCustomer = async () => {
        const data = await SelectTopIdCustomerNKM(setID, setNotificationModal, setModal, setModalType);
        if (data.length > 0) {
    ...
    return (
        <View style={{ paddingHorizontal: 10, backgroundColor: 'white', borderRadius: 10 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', gap: 10 }}>
                ...
                <View style={{flex:1, justifyContent:'space-around'}}>
                    <DropdownListAgenCustomer idAgen={idAgen} setIdAgen={setIdAgen} setSalesId={setSalesId} />
                </View>
            </View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around', gap: 10 }}>
                <View style={{ flex: 1, justifyContent: 'space-around' }}>
                    <DropdownListSalesForNakami salesId={salesId} setSalesId={setSalesId} />
                </View>
                <View style={{ flex: 1, justifyContent: 'space-around' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-around', gap:10}}>
                <View style={{flex:1, justifyContent:'space-around'}}>
                    <DropdownCustomerNakamiJenis jenis={jenis} setJenis={setJenis} />
                </View>
                <View style={{ flex: 1, justifyContent: 'space-around' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 10 }}>
...
export default FormAddDataCustomerNakami
