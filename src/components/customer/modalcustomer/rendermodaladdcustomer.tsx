...
export const renderErrorModal = ({setModal,setModalType,notificationModal}: props) => (
...
export const renderSuccessModal = ({ setModal, setModalType, notificationModal }: props) => (
    <View style={{ padding: 20 }}>
        <View style={styles.divContainer}>
            <View style={{ padding: 20 }}>
                <Image
