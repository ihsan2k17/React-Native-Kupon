...
import DropdownPeriode from '../modal/dropdown/dropdownperiodeNKM';
import DropdownHadiahNakamiJenis from '../modal/dropdown/dropdownjenisNKM';
interface form {
...
const FormEditHadiahNakami = ({hadiah, barang, periode, jenis, setHadiah, setBarang, setPeriode, setJenis}:form) => {
  return (
      <View style={{
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <DropdownHadiahNakamiJenis jenis={jenis} setJenis={setJenis}/>
          </View>
      </View>
  )
}

export default FormEditHadiahNakami
