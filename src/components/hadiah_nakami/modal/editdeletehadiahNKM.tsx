...
import { handletDeleteHadiahNKM } from '../../../service/fetchHadiahNakami'
...
const EditDeleteHadiahNakami = ({ setVisibleModal, item, Barang }: props) => {
    const [deleteConfirmation, setDeleteConfirmation] = useState(false);
    const [notification, setNotification] = useState('')
    const navigation = useNavigation<StackNavigationProp<RootStackParamList, 'editHadiahNakamiPage'>>();
    return (
                                ...
                                : <>
                                    ...
                                    <View style={{ flexDirection: 'row', gap: 10, paddingTop: 10 }}>
                                        <TouchableOpacity
                                            style={styles.buttonEditDelete}
                                            onPress={() => {
                                                handletDeleteHadiahNKM(Barang, setNotification)
                                            }}>
                            ...
                            <>
                                ...
                                <View style={{ flexDirection: 'row', gap: 10 }}>
                                    <TouchableOpacity
                                        onPress={() => {
                                            setVisibleModal(false)
                                            navigation.navigate('editHadiahNakamiPage',{hadiahNakamiBarang:item.Barang})
                                        }}
                                        style={styles.buttonEditDelete}
                                    >
...
export default EditDeleteHadiahNakami
