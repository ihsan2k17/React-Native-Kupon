...
const ModalMenuHadiah = ({ navigation, setModal }: props) => {
    /* pada dasar nya modal menu Hadiah ini akan memuatkan 2 handle yang menuju halaman masing masing
    yaitu Hadiah naiba atau pun nakami */
    return (
        <View style={{ alignItems: 'center' }}>
            ...
            <View>
                <Text style={styles.textHeading}>
                    Pilih halaman Hadiah yang ingin Anda buka:
                </Text>
                <View style={styles.innerContainerModal}>
                    <TouchableOpacity
                        style={styles.buttonNaiba}
                        onPress={() => {
                            navigation.navigate('hadiahPage')
                            setModal(false)
                        }}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            navigation.navigate('hadiahNakamiPage')
                            setModal(false)
                        }}>
...
export default ModalMenuHadiah
