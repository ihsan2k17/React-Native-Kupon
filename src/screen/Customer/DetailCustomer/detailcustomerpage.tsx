...
import { FetchCustomerlistNamabyCustomer, handleRefresh } from '../../../service/fetchCustomer';
...
const DetailCustomerPage = ({ route }: DetailCustomerProps) => {
  const { customerCustomer } = route.params;
  ...
  useEffect(() => {
    FetchCustomerlistNamabyCustomer(
      customerCustomer,
      setCustomerData,
      setNotificationModalCustomer,
      setModalCustomer
