...
import ModalEditDeleteKuponNakami from '../../../components/kupon_nakami/modaleditdeletekuponNKM';
    ...
    return (
        <View style={{ flex: 1, paddingHorizontal: 10, alignItems: 'center', borderRadius: 20, paddingTop: 10 }}>
            ...
            <Modal
                ...
                backdropOpacity={0.5}
            >
                <ModalEditDeleteKuponNakami setShowVisibleModal={setShowVisibleModal} item={item}/>
            </Modal>
        </View>
    );
}
