...
import { handleUpdateVoucherNakami } from '../../../service/fetchKuponNakami'
interface editVcrProps {
    route: RouteProp<RootStackParamList, 'EditVoucherNakami'>;
}
const EditVoucherNakami = ({ route }: editVcrProps) => {
    const { kuponnakamiId } = route.params;
    const { kuponnakamiPoin } = route.params;
    const { kuponnakamiVoucher } = route.params;
            ...
            <View>
                ...
                <View style={styles.containerButtonEdit}>
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            handleUpdateVoucherNakami(
                                voucher, hadiah, namahadiah, hadiahke, tahun, periode, kuponnakamiId,
                                kuponnakamiPoin, kuponnakamiVoucher, setNotificationModal, setModalType, setModal)
                        }}
                    >
...
export default EditVoucherNakami
