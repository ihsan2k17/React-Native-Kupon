...
import { handleUpDurKupon } from '../../../service/fetchKupon';
import { cekuserLogin, handleUpDurUserLogin } from '../../../service/fetchLogin';
import StopwatchComponent from '../../../components/Stopwatch';
import FormInputVoucher from '../../../components/kupon/inputvoucher/forminpoutvcr';
...
const InputVoucher = () => {
    ...
    const hanldeupDur = async () => {
        ...
        await handleUpDurKupon(id, poin, user, hadiah, elav, setNotificationModal, setModalType, setModal);
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Color.icon, paddingHorizontal: 10 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 10 }}>
                ...
                <Text style={{ fontSize: 20, fontFamily: Poppins.Bold, color: Color.border }}>Input Voucher</Text>
            ...
            <KeyboardAvoidingView behavior='padding' keyboardVerticalOffset={100}>
                ...
                <FormInputVoucher
                    ...
                    namahadiah={namahadiah} setNamahadiah={setNamaHadiah} voucher={voucher} setVoucher={setVoucher}
                    tahun={tahun} setTahun={setTahun} hadiahke={hadiahke} setHadiahke={setHadiahke}
                    hadiah={hadiah} setHadiah={setHadiah} periode={periode} setPeriode={setPeriode}
                    jenis={jenis} setJenis={setJenis} modal={modal} setModal={setModal} notificationModal={notificationModal}
