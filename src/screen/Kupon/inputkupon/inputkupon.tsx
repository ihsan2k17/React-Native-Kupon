...
import FormInputKupon from '../../../components/kupon/inputkupon/forminputkupon';
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Color.icon, paddingHorizontal: 10}}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop:10 }}>
                ...
                <Text style={{fontSize:20, fontFamily:Poppins.Bold, color:Color.border}}>Input Kupon</Text>
            ...
            <KeyboardAvoidingView behavior="padding" keyboardVerticalOffset={100}>
                ...
                <FormInputKupon
                    ...
                    namahadiah={namahadiah} setNamahadiah={setNamaHadiah} kupon={kupon} setKupon={setKupon}
                    ...
                    jenis={jenis} setJenis={setJenis} modal={modal} setModal={setModal}
