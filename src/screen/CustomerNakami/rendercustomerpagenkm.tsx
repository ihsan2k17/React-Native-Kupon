...
const RenderCustomerNakamiPage = ({ item, index, pointerIndex, setPointerIndex }: renderProps) => {
    ...
    const handleToCustomerDetail = () => {
        ...
        navigation.navigate('DetailCustomerNakamiPage', { customernakamiCustomer: item.Customer })
    }
    return (
        <View style={{
...
export default RenderCustomerNakamiPage
