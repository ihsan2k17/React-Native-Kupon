...
import { fetchCurrentListNamaByCustomerNKM } from '../../../service/fetchCustomerNakami'

interface props {
    customerData: CustomerNkm[]
...
export default ListCurrentCustomerNakami
