...
import { renderErrorModalCustomerNakami, renderSuccessModalCustomerNakami } from '../../../components/customer_nakami/modalcustomer/rendermodaladdcustomer'
import { AddDataCustomerNKM, handleRefreshCurrentCustNKM } from '../../../service/fetchCustomerNakami'
import ListCurrentCustomerNakami from './listcurrentcustomer'
import FormAddDataCustomerNakami from '../../../components/customer_nakami/addcustomer/formaddcustomerNakami'
import ModalInputKuponNakami from '../../../components/kupon_nakami/inputkupon/modalinputkuponnkm'


const AddCustomerNakami = () => {
    ...
    return (
        <SafeAreaView style={{backgroundColor:Color.icon, flex:1, padding:10, gap:10}}>
            ...
            <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                ...
                <View>
                    <TouchableOpacity
                        ...
                        onPress={() => handleRefreshCurrentCustNKM(
            ...
            <Modal isVisible={modal}>
                {modalType === 'success-add-customerNakami' && renderSuccessModalCustomerNakami({setModal, setModalType, notificationModal})}
                {modalType === 'error-add-customerNakami' && renderErrorModalCustomerNakami({setModal, setModalType, notificationModal})}
                {modalType === 'current-list-errorNakami' && renderErrorModalCustomerNakami({setModal, setModalType, notificationModal})}
            </Modal>
        </SafeAreaView>
    )
}

export default AddCustomerNakami;
